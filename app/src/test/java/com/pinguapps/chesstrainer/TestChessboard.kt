...
class TestChessboard {
    ...
    fun testGenerateBishopMoves() {
        ...
        //own piece block
        val g2moves = board.generatePieceMoves(board.getSquare("g2"))
        assertEquals(2, g2moves.size)

        val b3moves = board.generatePieceMoves(board.getSquare("b3"))
        assertEquals(1, b3moves.size)

        val b6moves = board.generatePieceMoves(board.getSquare("b6"))
        assertEquals(8, b6moves.size)

        val a7moves = board.generatePieceMoves(board.getSquare("a7"))
    ...
    fun testCastlingRights() {
        ...
        game.loadPositionFenString("r3k2r/1ppp1pp1/4p3/p6p/P6P/4P3/1PPP1PP1/R3K2R w KQkq - 0 1")
        assertEquals(board.whiteCastleKingRights, true)
        assertEquals(board.whiteCastleQueenRights, true)
        assertEquals(board.blackCastleQueenRights, true)
        assertEquals(board.blackCastleKingRights, true)
        game.makeMove("e1e2")
        assertEquals(board.whiteCastleQueenRights, false)
        assertEquals(board.whiteCastleKingRights, false)
        game.makeMove("h8h7")
        assertEquals(board.blackCastleQueenRights, true)
        assertEquals(board.blackCastleKingRights, false)
        game.loadPositionFenString("r3k2r/1ppp1pp1/4p3/p6p/P6P/4P3/1PPP1PP1/R3K2R w KQkq - 0 1")
        game.makeMove("e1c1")
        assertEquals(board.whiteCastleQueenRights, false)
        assertEquals(board.whiteCastleKingRights, false)
        game.makeMove("e8g8")
        assertEquals(board.blackCastleQueenRights, false)
        assertEquals(board.blackCastleKingRights, false)
